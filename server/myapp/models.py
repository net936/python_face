...
class Doctor(models.Model):
    ...
    id = models.BigAutoField(primary_key=True)
    title = models.CharField(max_length=100, blank=True, null=True)
    zhicheng = models.CharField(max_length=100, blank=True, null=True)  # 岗位
    desc = models.CharField(max_length=200, blank=True, null=True)  # 简介
    cover = models.ImageField(upload_to='cover/', null=True)  # 头像
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Thing(models.Model):
    ...
    youxiaoqi = models.CharField(max_length=50, blank=True, null=True)  # 有效期
    shiyong = models.CharField(max_length=100, blank=True, null=True)  # 适用人群
    tishi = models.CharField(max_length=100, blank=True, null=True)  # 温馨提示
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
